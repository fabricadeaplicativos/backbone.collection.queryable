...
console.log('Loading BackboneCollectionQueryable qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading BackboneCollectionQueryable qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing BackboneCollectionQueryable qUnit tests.');
